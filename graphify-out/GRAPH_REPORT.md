# Graph Report - UAV-S3  (2026-09-10)

## Corpus Check
- 114 files · ~249,672 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1487 nodes · 2717 edges · 133 communities (81 shown, 52 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 373 edges (avg confidence: 0.85)
...
Cohesion: 0.19
Nodes (23): vec3f_t, vec3f_zero(), imu_sample_t, vec3f_t, enter_kill_latch(), enter_kill_latch_ex(), flight_core_kill_now(), gyro_cal_enter_collect() (+15 more)
...
Cohesion: 0.07
Nodes (53): battery_driver_init(), battery_driver_read(), battery_driver_read_v(), battery_sample_t, esp_err_t, add_device_at(), esp_err_t, i2c_master_bus_handle_t (+45 more)
...
### Community 22 - "apply_command"
Cohesion: 0.20
Nodes (20): commander_clamp_altitude(), commander_config_t, fsm_transition(), abort_landing_to_hold(), apply_command(), fsm_state_t, fsm_on_arm_request(), fsm_on_bench_ramp_start() (+12 more)

### Community 23 - "commander.h"
Cohesion: 0.60
Nodes (4): commander_credit_stall(), commander_heartbeat(), commander_init(), commander_state_t
...
Cohesion: 0.13
Nodes (19): alt_hold_reset(), alt_hold_state_t, attitude_state_reset(), attitude_state_t, fsm_init(), landing_state_t, takeoff_state_t, landing_reset() (+11 more)
...
Cohesion: 0.14
Nodes (17): fsm_arm_guard_ok(), fsm_state_name(), fsm_state_t, alt_hold_tune_t, telemetry_snapshot_t, flight_core_get_alt_hold_tune(), flight_core_read_telemetry(), handle_alt() (+9 more)
...
Cohesion: 0.13
Nodes (10): board_config_fill(), flight_core_board_config_t, esp_err_t, cpu_bench_init(), app_main(), register_commands(), fsm_state_t, telemetry_format_alt_mode() (+2 more)
...
Cohesion: 0.13
Nodes (24): camera_fb_t, camera_selftest_t, camera_stats_t, camera_sync_probe_t, esp_err_t, camera_acquire_frame(), camera_deinit(), camera_get_stats() (+16 more)

### Community 123 - "Test D — records a known gap, not a protection"
Cohesion: 0.22
...
### Community 125 - "stabilize_task"
Cohesion: 0.15
Nodes (14): sensor_health_t, sensor_hub_age_us(), imu_driver_get_config(), TickType_t, finalize_mag_calibration(), gyro_cal_state_active(), prearm_check(), publish_kill_tick_telemetry() (+6 more)
...
Cohesion: 0.22
Nodes (5): ColorDetector, Mat na nhi phan cho MOT profile; tach rieng de GUI xem duoc., Tra list[Detection], sap theo dien tich giam dan (to nhat truoc)., Ve khung + tam len BAN SAO — ve de len anh goc se doi mau cua no, va phan dieu…, Tim cac vet mau theo profile. Mot the hien dung lai duoc moi khung.
...
- **Why does `stabilize_task()` connect `stabilize_task` to `flight_core.c`, `flight_core_start`, `sensor_hub.c`, `types.h`, `attitude_control_update`, `mahony_filter.c`, `alt_estimator.c`, `hover_model.c`, `imu_driver.c`, `BMP280 Barometer Driver`, `commander_evaluate`, `takeoff_run`, `motor_driver.c`, `calibration.c`, `apply_command`, `commander.h`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `flight_core_start()` connect `flight_core_start` to `flight_core.c`, `fc_module.c`, `sensor_hub.c`, `mahony_filter.c`, `attitude_control_update`, `alt_estimator.c`, `imu_driver.c`, `BMP280 Barometer Driver`, `mag_driver.c`, `commander_evaluate`, `takeoff_run`, `motor_driver.c`, `calibration.c`, `commander.h`, `app_config.h`, `stabilize_task`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
