...
## Corpus Check
- 114 files · ~249,420 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1487 nodes · 2717 edges · 132 communities (79 shown, 53 thin omitted)
...
## Communities (132 total, 53 thin omitted)

### Community 0 - "stabilize_task"
Cohesion: 0.13
Nodes (34): vec3f_t, vec3f_zero(), imu_driver_get_config(), imu_sample_t, TickType_t, vec3f_t, enter_kill_latch(), finalize_mag_calibration() (+26 more)
...
Cohesion: 0.23
Nodes (13): clampi(), esp_err_t, configure_channel(), motor_driver_all_off(), motor_driver_arm(), motor_driver_disarm(), motor_driver_init(), motor_driver_set_armed() (+5 more)
...
### Community 127 - "Two-Tier Architecture (core 0 command source / core 1 flight loop)"
Cohesion: 0.14
...
- **Why does `stabilize_task()` connect `stabilize_task` to `flight_core_start`, `sensor_hub.c`, `types.h`, `attitude_control_update`, `mahony_filter.c`, `alt_estimator.c`, `hover_model.c`, `imu_driver.c`, `BMP280 Barometer Driver`, `commander_evaluate`, `takeoff_run`, `motor_driver.c`, `calibration.c`, `apply_command`, `commander.h`, `sensor_hub_age_us`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `flight_core_start()` connect `flight_core_start` to `stabilize_task`, `fc_module.c`, `sensor_hub.c`, `mahony_filter.c`, `attitude_control_update`, `alt_estimator.c`, `imu_driver.c`, `BMP280 Barometer Driver`, `mag_driver.c`, `commander_evaluate`, `takeoff_run`, `motor_driver.c`, `calibration.c`, `commander.h`, `app_config.h`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `flight_core_push_command()` connect `main.c` to `stabilize_task`, `fc_module.c`, `flight_core_read_telemetry`, `command_parser.c`, `net_link.c`?**
