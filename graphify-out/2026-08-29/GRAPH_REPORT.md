...
## Corpus Check
- 89 files · ~213,733 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1122 nodes · 2227 edges · 100 communities (57 shown, 43 thin omitted)
...
Cohesion: 0.06
Nodes (57): battery_driver_init(), battery_driver_read(), battery_driver_read_v(), battery_sample_t, esp_err_t, add_device_at(), esp_err_t, i2c_master_bus_handle_t (+49 more)

### Community 2 - "fc_module.c"
Cohesion: 0.12
Nodes (43): command_t, move_dir_t, telemetry_snapshot_t, fc_bridge_get_control_input(), fc_bridge_init(), fc_bridge_parse_move_dir(), fc_bridge_push(), fc_bridge_read_telemetry() (+35 more)
...
### Community 4 - "flight_core_start"
Cohesion: 0.28
Nodes (9): fsm_init(), telemetry_snapshot_t, telemetry_snapshot_init(), esp_err_t, flight_core_board_config_t, i2c_master_bus_handle_t, flight_core_start(), init_i2c_bus() (+1 more)
...
### Community 6 - "tuning.h"
Cohesion: 0.24
Nodes (6): alt_hold_reset(), alt_hold_state_t, commander_credit_stall(), commander_heartbeat(), commander_init(), commander_state_t
...
### Community 19 - "clampf"
Cohesion: 0.11
Nodes (31): alt_hold_result_t, clampf(), alt_hold_default_tune(), alt_hold_preload(), alt_hold_run(), alt_hold_vz_cascade(), alt_hold_state_t, alt_hold_tune_t (+23 more)
...
Cohesion: 0.21
Nodes (21): imu_sample_t, vec3f_t, enter_kill_latch(), enter_kill_latch_ex(), flight_core_get_control_input(), flight_core_kill_now(), gyro_cal_enter_collect(), gyro_cal_finish_fail() (+13 more)
...
Cohesion: 0.14
Nodes (5): alt_source_t, alt_source_name(), mahony_t, quat_t, mahony_quaternion()
...
### Community 93 - "stabilize_task"
Cohesion: 0.16
Nodes (17): sensor_health_t, sensor_hub_age_us(), landing_state_t, takeoff_state_t, landing_reset(), takeoff_airborne(), takeoff_begin(), takeoff_control_active() (+9 more)

### Community 94 - "handle_alt"
Cohesion: 0.29
...
### Community 95 - "attitude_state_reset"
Cohesion: 0.38
...
- **Why does `flight_core_start()` connect `flight_core_start` to `sensor_hub.c`, `fc_module.c`, `mahony_filter.c`, `tuning.h`, `alt_estimator.c`, `baro_driver.c`, `mag_driver.c`, `app_config.h`, `imu_driver.c`, `clampf`, `attitude_control_update`, `calibration.c`, `flight_core.c`, `motor_driver.c`, `commander_evaluate`, `stabilize_task`, `attitude_state_reset`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `stabilize_task()` connect `stabilize_task` to `sensor_hub.c`, `imu_driver_get_config`, `mahony_filter.c`, `tuning.h`, `hover_model.c`, `alt_estimator.c`, `apply_command`, `baro_driver.c`, `clampf`, `attitude_control_update`, `calibration.c`, `flight_core.c`, `motor_driver.c`, `commander_evaluate`, `types.h`, `imu_driver.c`, `attitude_state_reset`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `flight_core_push_command()` connect `flight_core_push_command` to `fc_module.c`, `command_parser.c`, `net_link.c`, `flight_core_read_telemetry`, `flight_core.c`, `handle_alt`?**
